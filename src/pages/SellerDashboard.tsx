...
const ActionCard = ({ icon, label, onClick, badge }: { icon: React.ReactNode; label: string; onClick: () => void; badge?: number }) => (
  <button onClick={onClick} className="relative rounded-2xl py-8 px-3 flex flex-col items-center gap-3 border" style={{ color: '#A35233', background: '#fff5e5', borderColor: '#E8D5C4' }}>
    {badge !== undefined && (
