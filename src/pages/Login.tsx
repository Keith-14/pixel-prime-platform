      ...
      <div className="relative z-10 w-full px-6">
        ...
        <div className="space-y-6">
          <div className="text-center">
            <h2 className="text-lg font-semibold text-sage mb-2">Create an account</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="text-center">
              <span className="text-sm text-sage/60 bg-cream px-3">or</span>
              <div className="border-t border-sage/20 -mt-3 -z-10 relative"></div>
            </div>
